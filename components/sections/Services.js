      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="services-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => {
            // Use different fire safety images for each service
            const serviceImages = [
              '/content images to be used/extinguisher-17149_1280.jpg',
              '/content images to be used/istockphoto-2161672281-1024x1024.jpg',
              '/content images to be used/istockphoto-2230952154-1024x1024.jpg',
              '/content images to be used/istockphoto-2239484945-1024x1024.jpg',
              '/content images to be used/istockphoto-960450450-1024x1024.jpg',
              '/content images to be used/extinguisher-17149_960_720.jpg'
            ];
